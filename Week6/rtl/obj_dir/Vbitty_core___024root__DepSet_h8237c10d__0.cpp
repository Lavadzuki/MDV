...
VL_INLINE_OPT void Vbitty_core___024root___nba_sequent__TOP__1(Vbitty_core___024root* vlSelf) {
    ...
    if (vlSelfRef.rst) {
        ...
        vlSelfRef.bitty_core__DOT____Vcellout__R0__d_out = 0U;
        vlSelfRef.bitty_core__DOT____Vcellout__R1__d_out = 0U;
        vlSelfRef.bitty_core__DOT____Vcellout__R2__d_out = 0U;
        vlSelfRef.bitty_core__DOT____Vcellout__R3__d_out = 0U;
        vlSelfRef.bitty_core__DOT____Vcellout__R4__d_out = 0U;
        vlSelfRef.bitty_core__DOT____Vcellout__R5__d_out = 0U;
        vlSelfRef.bitty_core__DOT____Vcellout__R6__d_out = 0U;
        vlSelfRef.bitty_core__DOT____Vcellout__R7__d_out = 0U;
        ...
        if (vlSelfRef.debug_load) {
            vlSelfRef.bitty_core__DOT____Vcellout__R0__d_out 
                = vlSelfRef.debug_init_0;
            vlSelfRef.bitty_core__DOT____Vcellout__R1__d_out 
                = vlSelfRef.debug_init_1;
            vlSelfRef.bitty_core__DOT____Vcellout__R2__d_out 
                = vlSelfRef.debug_init_2;
            vlSelfRef.bitty_core__DOT____Vcellout__R3__d_out 
                = vlSelfRef.debug_init_3;
            vlSelfRef.bitty_core__DOT____Vcellout__R4__d_out 
                = vlSelfRef.debug_init_4;
            vlSelfRef.bitty_core__DOT____Vcellout__R5__d_out 
                = vlSelfRef.debug_init_5;
            vlSelfRef.bitty_core__DOT____Vcellout__R6__d_out 
                = vlSelfRef.debug_init_6;
            vlSelfRef.bitty_core__DOT____Vcellout__R7__d_out 
                = vlSelfRef.debug_init_7;
        } else {
        ...
        if (vlSelfRef.bitty_core__DOT__en_c) {
            vlSelfRef.bitty_core__DOT__c_out = ((IData)(vlSelfRef.bitty_core__DOT__ALU_mode)
                                                 ? (IData)(vlSelfRef.bitty_core__DOT__alu_unit__DOT__logic_result)
                                                 : (IData)(vlSelfRef.bitty_core__DOT__alu_unit__DOT__arith_result));
        }
    }
...
VL_INLINE_OPT void Vbitty_core___024root___nba_sequent__TOP__2(Vbitty_core___024root* vlSelf) {
    ...
    if ((2U & (IData)(vlSelfRef.bitty_core__DOT__CU__DOT__current_state))) {
        if ((1U & (~ (IData)(vlSelfRef.bitty_core__DOT__CU__DOT__current_state)))) {
            ...
            vlSelfRef.bitty_core__DOT__ALU_mode = vlSelfRef.bitty_core__DOT__CU__DOT__ALU_mode;
        }
        if ((1U & (IData)(vlSelfRef.bitty_core__DOT__CU__DOT__current_state))) {
...
VL_INLINE_OPT void Vbitty_core___024root___nba_sequent__TOP__3(Vbitty_core___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.bitty_core__DOT__CU__DOT__ALU_mode = 
        ((1U & (~ ((IData)(vlSelfRef.rst) | (~ (IData)(vlSelfRef.run))))) 
         && (1U & ((IData)(vlSelfRef.instruction) >> 2U)));
    if ((1U & ((IData)(vlSelfRef.rst) | (~ (IData)(vlSelfRef.run))))) {
