...
Vbitty_core::Vbitty_core(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , debug_init_0{vlSymsp->TOP.debug_init_0}
    , debug_init_1{vlSymsp->TOP.debug_init_1}
    , debug_init_2{vlSymsp->TOP.debug_init_2}
    , debug_init_3{vlSymsp->TOP.debug_init_3}
    , debug_init_4{vlSymsp->TOP.debug_init_4}
    , debug_init_5{vlSymsp->TOP.debug_init_5}
    , debug_init_6{vlSymsp->TOP.debug_init_6}
    , debug_init_7{vlSymsp->TOP.debug_init_7}
    , r0_out{vlSymsp->TOP.r0_out}
    , r1_out{vlSymsp->TOP.r1_out}
    , r2_out{vlSymsp->TOP.r2_out}
    , r3_out{vlSymsp->TOP.r3_out}
    , r4_out{vlSymsp->TOP.r4_out}
    , r5_out{vlSymsp->TOP.r5_out}
    , r6_out{vlSymsp->TOP.r6_out}
    , r7_out{vlSymsp->TOP.r7_out}
    , rootp{&(vlSymsp->TOP)}
{
